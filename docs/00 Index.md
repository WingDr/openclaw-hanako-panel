...
2. ​`09 MVP 前端页面树与组件结构 2026-03-22`
3. ​`10 Gateway WS 客户端数据流草案 2026-03-22`
4. ​`11 Panel Proxy 最小接口协议 v0.1 2026-03-22`
5. ​`05 局域网 HTTP 与薄网关方案 2026-03-21`
6. ​`06 Panel Proxy 设计 2026-03-21`
7. ​`07 前端网页实现方案与参考实现 2026-03-22`
...
- session 元数据与 panel 本地展示模型
- `panel-web/` 与 `panel-proxy/` 的实际目录初始化方案
- MVP API / WS schema 的 Zod 类型文件草案
